...
public class MainUpdateSubscriptionPlan {
    public static void main(String[] args) {
        ...
        Company company = new Company("12345678901234", "JBS Global", "prédio", "jbsGlobal@gmail.com", data, "SP","Irineu José Bordom", "São Paulo", "Vila Jaguaré", "97999999", "9999", "Empresa Global de Alimentos " );
