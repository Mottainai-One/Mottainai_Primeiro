...
public class MainUpdateUserAccount {
    public static void main(String[] args) {
        ...
        UserAccount userAccount = new UserAccount(3, "Neto", "interMottainai@gmail.com", "09876543210", data03, hora, "Inativo", "Gerente", employee);
